...
//       router.push("/events")
//     } catch (error) {
//       console.error("Navigation error:", error) // Debug log for navigation errors
//     }
//   }
...
//       <Card className="mb-8">
//         <CardHeader className="relative pb-8 border-b">
//           <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-r from-primary to-primary/60" />
//           <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-4 pt-20">
//             <Avatar className="w-24 h-24 border-4 border-background">
//               <AvatarImage src="/placeholder.svg" />
//               <AvatarFallback>
...
//               </div>
//             </div>
//             <Button className="md:ml-auto" variant="outline" onClick={handleEditProfile} type="button">
//               Edit Profile
//             </Button>
//           </div>
//         </CardHeader>
